...
public interface IMediationStrategiesDao extends CrudRepository<MediationStrategies,Long> {
	...
	@Query(value="SELECT m.mediation_strategies_id, m.content, m.interest, m.resources, m.correlation_id, m.unit, m.strategy, m.indicator, m.holy_day_option, m.comment \r\n" +
